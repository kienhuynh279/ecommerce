...
const propSuff = ['', 'Top', 'Bottom', 'Left', 'Right', 'LeftRight', 'TopBottom'];
const mp = { m: 'margin', p: 'padding' };

const generateMarginPadding = (start = 0, end = 25, increment = 0.25, unit = 'rem') => {
...
const generateHeightWidth = (start = 0, end = 400, increment = 4, unit = 'px') => {
  let classList: Record<string, any> = {};
